...
public:
    void run() {
        ...
        std::cout << "4. Odbiór w trybie binarnym" << std::endl;
        ...
        if (choice == 1) {
            ...
            if (binChoice == 1) {
                ...
                std::string path;
                std::cout << "Podaj nazwę pliku do wysyłania: ";
            ...
            std::cout << "Wprowadź tekst do wysłania: ";
            ...
            if (ok) {
                std::cout << "[Sender] Wysłano dane poprawnie." << std::endl;
            } else {
                std::cout << "[Sender] Wystąpił błąd podczas wysyłania." << std::endl;
            }
            delete terminator;
        }
        else {
